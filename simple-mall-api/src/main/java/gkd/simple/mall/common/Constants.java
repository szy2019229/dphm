...
public class Constants {
    public final static String FILE_UPLOAD_DIC = "/opt/simple/upload/";//上传文件的默认url前缀，根据部署设置自行修改
//    public final static String FILE_UPLOAD_DIC = "D:\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static String MALL_USER_SESSION_KEY = "simpleMallUser";//session中user的key
