...
package gkd.simple.mall.config;
...
public class Swagger2Config {
    ...
    public Docket api() {
        ...
        tokenParam.name("token").description("用户（或管理员）认证信息")
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("gkd.simple.mall.api"))// 修改为自己的 controller 包路径
