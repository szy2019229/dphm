...
# Dump of table tb_simple_mall_admin_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_admin_user`;

CREATE TABLE `tb_simple_mall_admin_user` (
...
LOCK TABLES `tb_simple_mall_admin_user` WRITE;
/*!40000 ALTER TABLE `tb_simple_mall_admin_user` DISABLE KEYS */;

INSERT INTO `tb_simple_mall_admin_user` (`admin_user_id`, `login_user_name`, `login_password`, `nick_name`, `locked`)
VALUES
(1,'admin','e10adc3949ba59abbe56e057f20f883e','十三',0),
(2,'simple-admin1','e10adc3949ba59abbe56e057f20f883e','新蜂01',0),
(3,'simple-admin2','e10adc3949ba59abbe56e057f20f883e','新蜂02',0);

/*!40000 ALTER TABLE `tb_simple_mall_admin_user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_simple_mall_carousel
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_carousel`;

CREATE TABLE `tb_simple_mall_carousel` (
...
LOCK TABLES `tb_simple_mall_carousel` WRITE;
/*!40000 ALTER TABLE `tb_simple_mall_carousel` DISABLE KEYS */;

INSERT INTO `tb_simple_mall_carousel` (`carousel_id`, `carousel_url`, `redirect_url`, `carousel_rank`, `is_deleted`, `create_time`, `create_user`, `update_time`, `update_user`)
VALUES
(1,'http://118.178.89.44:28019/goods-img/banner1.jpg','##',200,1,'2019-08-23 17:50:45',0,'2019-11-10 00:23:01',0),
(2,'http://118.178.89.44:28019/goods-img/banner2.jpg','##',13,0,'2019-11-29 00:00:00',0,'2019-11-29 00:00:00',0),
(3,'http://118.178.89.44:28019/goods-img/banner3.jpg','##',0,1,'2019-09-18 18:26:38',0,'2019-11-10 00:23:01',0);

/*!40000 ALTER TABLE `tb_simple_mall_carousel` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_simple_mall_goods_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_goods_category`;

CREATE TABLE `tb_simple_mall_goods_category` (
...
LOCK TABLES `tb_simple_mall_goods_category` WRITE;
/*!40000 ALTER TABLE `tb_simple_mall_goods_category` DISABLE KEYS */;

INSERT INTO `tb_simple_mall_goods_category` (`category_id`, `category_level`, `parent_id`, `category_name`, `category_rank`, `is_deleted`, `create_time`, `create_user`, `update_time`, `update_user`)
VALUES
...
/*!40000 ALTER TABLE `tb_simple_mall_goods_category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_simple_mall_goods_info
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_goods_info`;

CREATE TABLE `tb_simple_mall_goods_info` (
...
LOCK TABLES `tb_simple_mall_goods_info` WRITE;
/*!40000 ALTER TABLE `tb_simple_mall_goods_info` DISABLE KEYS */;

INSERT INTO `tb_simple_mall_goods_info` (`goods_id`, `goods_name`, `goods_intro`, `goods_category_id`, `goods_cover_img`, `goods_carousel`, `goods_detail_content`, `original_price`, `selling_price`, `stock_num`, `tag`, `goods_sell_status`, `create_user`, `create_time`, `update_user`, `update_time`)
VALUES
...
/*!40000 ALTER TABLE `tb_simple_mall_goods_info` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_simple_mall_index_config
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_index_config`;

CREATE TABLE `tb_simple_mall_index_config` (
...
LOCK TABLES `tb_simple_mall_index_config` WRITE;
/*!40000 ALTER TABLE `tb_simple_mall_index_config` DISABLE KEYS */;

INSERT INTO `tb_simple_mall_index_config` (`config_id`, `config_name`, `config_type`, `goods_id`, `redirect_url`, `config_rank`, `is_deleted`, `create_time`, `create_user`, `update_time`, `update_user`)
VALUES
...
/*!40000 ALTER TABLE `tb_simple_mall_index_config` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_simple_mall_order
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_order`;

CREATE TABLE `tb_simple_mall_order` (
...
# Dump of table tb_simple_mall_order_address
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_order_address`;

CREATE TABLE `tb_simple_mall_order_address` (
...
# Dump of table tb_simple_mall_order_item
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_order_item`;

CREATE TABLE `tb_simple_mall_order_item` (
...
# Dump of table tb_simple_mall_shopping_cart_item
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_shopping_cart_item`;

CREATE TABLE `tb_simple_mall_shopping_cart_item` (
...
# Dump of table tb_simple_mall_user
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_user`;

CREATE TABLE `tb_simple_mall_user` (
...
LOCK TABLES `tb_simple_mall_user` WRITE;
/*!40000 ALTER TABLE `tb_simple_mall_user` DISABLE KEYS */;

INSERT INTO `tb_simple_mall_user` (`user_id`, `nick_name`, `login_name`, `password_md5`, `introduce_sign`, `is_deleted`, `locked_flag`, `create_time`)
VALUES
...
/*!40000 ALTER TABLE `tb_simple_mall_user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tb_simple_mall_user_address
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_user_address`;

CREATE TABLE `tb_simple_mall_user_address` (
...
# Dump of table tb_simple_mall_user_token
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tb_simple_mall_user_token`;

CREATE TABLE `tb_simple_mall_user_token` (
                                             `user_id` bigint(20) NOT NULL COMMENT '用户主键id',
...
CREATE TABLE `tb_admin_user_token` (
                                       `admin_user_id` bigint(20) NOT NULL COMMENT '管理员用户主键id',
                                       `token` varchar(32) NOT NULL COMMENT 'token值(32位字符串)',
                                       `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '修改时间',
                                       `expire_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'token过期时间',
