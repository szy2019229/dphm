<template>
  <div class="order-detail-box">
    ...
    <div class="order-status">
      ...
      <!-- <van-button v-if="[1,2,3].includes(detail.orderStatus)" style="margin-bottom: 10px" color="#666600" block @click="confirmOrder(detail.orderNo)">确认订单</van-button> -->
      <van-button v-if="detail.orderStatus == 0" style="margin-bottom: 10px" color="#666600" block @click="showPayFn">去支付</van-button>
    ...
    <van-card
      v-for="item in detail.simpleMallOrderItemVOS"
      :key="item.goodsId"
      ...
      :thumb="`//118.178.89.44:28019${item.goodsCoverImg}`"
    />
    <van-popup
      v-model="showPay"
      position="bottom"
