<template>
  <div class="seting-box">
    ...
    <van-button class="save-btn" color="#666600" type="primary" @click="save" block>保存</van-button>
    <van-button class="save-btn" color="#666600" type="primary" @click="logout" block>退出登录</van-button>
  </div>
</template>
