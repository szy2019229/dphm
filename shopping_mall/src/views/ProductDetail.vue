  ...
  <div class="product-detail">
    ...
    <div class="detail-content">
      <div class="detail-swipe-wrap">
        <van-swipe class="my-swipe" indicator-color="#666600">
          <van-swipe-item v-for="(item, index) in detail.goodsCarouselList" :key="index">
            <img :src="`//118.178.89.44:28019${item}`" alt="">
          </van-swipe-item>
        </van-swipe>
      </div>
...
<style lang="less">
  ...
  .product-detail {
    ...
    .van-goods-action-button--warning {
      background: linear-gradient(to right,#666600, @primary)
    }
    .van-goods-action-button--danger {
      background: linear-gradient(to right, #666600, #666600)
    }
  }
</style>
