  ...
  <div class="create-order">
    ...
    <div class="good">
      <div class="good-item" v-for="(item, index) in cartList" :key="index">
        <div class="good-img"><img :src="`//118.178.89.44:28019${item.goodsCoverImg}`" alt=""></div>
        <div class="good-desc">
    ...
    <div class="pay-wrap">
      ...
      <van-button @click="createOrder" class="pay-btn" color="#666600" type="primary" block>生成订单</van-button>
    </div>
    <van-popup
      closeable
